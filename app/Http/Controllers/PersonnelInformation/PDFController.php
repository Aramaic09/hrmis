...
class PDFController extends Controller
{
    ...
    public function pds()
    {
    	...
    	array_push($arr,App\Employee_recognition::where('user_id',Auth::user()->id)->count());
    	rsort($arr);
    	...
    	$data = [
            ...
            'training' => App\Employee_training::where('user_id',Auth::user()->id)->whereNotNull('training_approved_by')->orderBy('training_inclusive_dates','desc')->get(),
            'total_row' => $arr,
            'skill' => App\Employee_skill::where('user_id',Auth::user()->id)->pluck('skill_desc')->toArray(),
            'recognition' => App\Employee_recognition::where('user_id',Auth::user()->id)->pluck('recog_desc')->toArray(),
