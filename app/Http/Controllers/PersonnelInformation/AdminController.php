...
class AdminController extends Controller
{
    ...
    public function index()
    {
        ...
        $data = [
                    "nav" => nav("numemp"),
                    "employee" => App\View_user::where('usertype','!=','Administrator')->whereNotIn('employment_id',[9,10,12])->orderBy('username')->get(),
    ...
    public function archived()
    {
        ...
        $data = [
                    "nav" => nav("arvnum"),
                    "employee" => App\View_archived_user::where('usertype','!=','Administrator')->orderBy('username')->get(),
                ];
    ...
    public function requestAction()
    {
        switch (request()->status) {
            case 'receive':
                ...
                $status = "Received by Personnel, and forwarded to FAD-Budget";
