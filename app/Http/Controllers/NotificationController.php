    ...
    class NotificationController extends Controller
    {
        ...
        public function marshal()
        {
            ...
            switch (Auth::user()->division) {
                ...
                case 'q':
                        //BUDGET CLEARANCE
                        $req = App\Request_for_hiring::where('request_status','For FAD-Budget clearance')->count();
                        $data[] = array("total" => $req,"title" => "Letter for Approval","url" => url('recruitment/letter-approval'));
                    break;
                //OED-ARMMS
                case 'A':
                        //ARMSS CLEARANCE
                        $req = App\Request_for_hiring::where('request_status','For OED-ARMSS clearance')->count();
                        $data[] = array("total" => $req,"title" => "Letter for Approval","url" => url('recruitment/letter-approval'));
                ...
                case 'O':
                        //OED CLEARANCE
                        $req = App\Request_for_hiring::where('request_status','For OED`s Approval')->count();
                        $data[] = array("total" => $req,"title" => "Letter for Approval","url" => url('recruitment/letter-approval'));
