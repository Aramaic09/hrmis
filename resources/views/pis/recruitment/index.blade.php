              ...
              <table id="tbl" class="table table-bordered table-striped">
                ...
                <tr>
                  <th style="width: 2%">#</th>
                        ...
                        <th style="width: 10%" class="text-center">Vacancy Advise</th>
                      ...
                      @if($lists->request_status != 'Disapproved' || $lists->request_status != 'Closed')
                          ...
                          <tr>
                            ...
                            <td class="text-center">
                              ...
                              @if($lists->request_status == 'Re-upload Vacancy Advise for Reposting' || $lists->request_status == 'Received for Reposting')
                                -
                              @else
                                {{ getFile('hiring','Vacancy Advise',$lists->id) }}
                              @endif
                            ...
                            <td>
                              ...
                              @elseif($lists->request_status == 'Upload Vacancy Advise' || $lists->request_status == 'Re-upload Vacancy Advise for Reposting')
                                  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                    <a class="dropdown-item" href="#" onclick="modalOption('hiring','upload-vacancy',{{ $lists->id }})"><i class="fas fa-upload"></i> Upload Vacancy Advise</a>
                              
                              @elseif($lists->request_status == 'Vacancy Advise Uploaded')
                                @if($lists->plantilla_id != null)
                                  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                      ...
                                      <a class="dropdown-item" href="#" onclick="actionRequest('posted','{{ $lists->plantilla_id }}',{{ $lists->id }})"><i class="fas fa-check"></i> Posted</a>
                               ...
                               @elseif($lists->request_status == 'Posted')
                                      <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
...
<div class="modal fade" id="modal-vacancy">
  <div class="modal-dialog" style="max-width: 30% !important">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title">Upload Vacancy Advise</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        <form method="POST" id="frm2" enctype="multipart/form-data" role="form" action="{{ url('recruitment/upload/vacancy-advise') }}">
            ...
            <input type="hidden" name="frm_url_reset" id="frm_url_reset" value="{{ url('recruitment/upload/vacancy-advise') }}">
