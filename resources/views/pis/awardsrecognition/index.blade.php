  ...
  <div class="col-12">
              ...
              <div class="card-header p-0 border-bottom-0">
                <ul class="nav nav-tabs" id="custom-tabs-three-tab" role="tablist">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" id="custom-tabs-three-profile-tab" data-toggle="pill" href="#tabs-training" role="tab" aria-controls="tabs-attendance" aria-selected="false">Perfect Attendance</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" id="custom-tabs-three-profile-tab" data-toggle="pill" href="#tabs-hrd" role="tab" aria-controls="tabs-flag" aria-selected="false">Flag Ceremony</a>
                  </li>
                </ul>
              </div>
              <div class="card-body">
