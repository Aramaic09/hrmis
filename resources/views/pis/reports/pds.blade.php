...
<tr>
 ...
 <td colspan="6" valign="top" class="text2">
  ...
  <tr><td colspan="2" width="64" valign="top" class="text2"><input type="checkbox" class="select"/>&nbsp;
   		<font style='font-size:10px'>Male</font></td><td colspan="2" width="64" valign="top" class="text2"><input type="checkbox" class="select"/>&nbsp;
...
<tr>
 ...
 <td colspan="6" rowspan="2" valign="top">
  <table cellspacing="0" border="0" cellpadding="0" width="100%">
  <tr><td colspan="2" width="64" valign="top" class="text2"><input type="checkbox" class="select"/><font style='font-size:9px'>&nbsp;Single</font></td><td colspan="2" width="64" valign="top" class="text2"><input type="checkbox" class="select"/><font style='font-size:9px'>&nbsp;Married</font></td></tr><tr><td colspan="2" width="64" valign="top" class="text2"><input type="checkbox" class="select"/><font style='font-size:9px'>&nbsp;Widowed</font></td><td colspan="2" width="64" valign="top" class="text2"><input type="checkbox" class="select"/><font style='font-size:9px'>&nbsp;Separated</font></td></tr><tr><td colspan="2" width="64" valign="top" class="text2"><input type="checkbox" class="select"/><font style='font-size:9px'>&nbsp;Annuled</font></td><td colspan="2" width="64" valign="top" class="text2"><input type="checkbox" class="select"/><font style='font-size:9px'>&nbsp;Divorced</font></td></tr>  </table>  
 </td>
 <td class="text noBot" colspan="4" rowspan="3" valign="top">17. RESIDENTIAL ADDRESS
 <td class="text2 noRight" colspan="3" align="center" ><font style='font-size:8px'><br/>House/Block/Lot No.</font></td>
 <td class="text2 noLeft" colspan="4" align="center" ><font style='font-size:8px'><br/>Street</font></td>
</tr>
<tr>
 <td class="text2 noRight" colspan="3" align="center"><font style='font-size:8px'><br/>Subdivision/Village</font></td>
 <td class="text2 noLeft" colspan="4" align="center"><font style='font-size:8px'><br/>Barangay</font></td>
</tr>
<tr>
 ...
 <td class="text2 noRight" colspan="3" align="center"><font style='font-size:8px'><br/>City/Municipality</font></td>
 <td class="text2 noLeft" colspan="4" align="center"><font style='font-size:8px'><br/>Province</font></td>
</tr>
<tr>
 ...
 <td class="text2" colspan="7" valign="top" style="padding-left:5px;"></td>
</tr>
<tr>
...
<tr>
 ...
 <td colspan="7" align="top" class="text2"></td>
</tr>
<tr>
 <td colspan="4" class="text" valign="top">15. AGENCY EMPLOYEE NO.</td>
 <td colspan="6" valign="top" class="text2"></td>
...
<tr>
 ...
 <td colspan="7" rowspan="13" valign="top" class="text">
  <table border="1" style="border-collapse:collapse; border-color:#000000; font-size:10px; font-family:arial" width="100%">
   <tr>
	...
	<td class="text" width="50%" align="center">&nbsp;</td>
   </tr>
   <tr>
    <td class="text" width="50%">&nbsp;</td>
	<td class="text" width="50%" align="center">&nbsp;</td>
...
<?php
  foreach ($data['education'] as $education) {
    ...
    echo '<tr>
           <td colspan="4" valign="top" class="text" style="padding-left:5px;">'.$education->educ_level_desc.'</td>
           <td colspan="5" valign="top" class="text">'.$education->educ_school.'</td>
           <td colspan="4" valign="top" class="text">'.$education->educ_course.'</td>
           <td colspan="1" align="center" valign="top" class="text">'.$education->educ_date_from.'</td>
           <td colspan="1" align="center" valign="top" class="text">'.$education->educ_date_to.'</td> 
           <td colspan="2" valign="top" class="text">'.$education->educ_highest.'</td>
           <td colspan="2" valign="top" class="text" align="center">'.$education->educ_date_to.'</td>
           <td colspan="2" valign="top" class="text">'.$education->educ_awards.'</td>
          </tr>';
  }
?>
...
<?php
  foreach ($data['eligibility'] as $eligibilities) {
    # code...
    echo '<tr>
           <td colspan="7" width="160" class="text">&nbsp;'.$eligibilities->cse_title.'</td>
           <td colspan="2" width="64" class="text">&nbsp;'.$eligibilities->cse_rating.'</td>
           <td colspan="2" width="96" class="text">&nbsp;'.$eligibilities->cse_date.'</td>
           <td colspan="6" width="160" class="text">&nbsp;'.$eligibilities->cse_place.'</td>
           <td colspan="2" width="96" class="text">&nbsp;'.$eligibilities->cse_license_num.'</td>
           <td colspan="2" width="96" class="text">&nbsp;'.$eligibilities->cse_license_date.'</td>
          </tr>';
  }
?>

<tr>
 <td colspan="7" width="160" class="text2">&nbsp;</td>
 <td colspan="2" width="64" class="text2">&nbsp;</td>
 <td colspan="2" width="96" class="text2">&nbsp;</td>
 <td colspan="6" width="160" class="text2">&nbsp;</td>
 <td colspan="2" width="96" class="text2">&nbsp;</td>
 <td colspan="2" width="96" class="text2">&nbsp;</td>
</tr>
<tr>
...
<?php
  foreach ($data['work'] as $works) {
    # code...
    echo '<tr>
           <td d colspan="2" width="64" class="text" align="center">&nbsp;'.$works->workexp_date_from.'</td>
           <td d colspan="2" width="64" class="text" align="center">&nbsp;'.$works->workexp_date_to.'</td>
           <td colspan="5" width="160" class="text">&nbsp;'.$works->workexp_title.'</td>
           <td colspan="4" width="160" class="text">&nbsp;'.$works->workexp_company.'</td>
           <td colspan="2" width="64" class="text">&nbsp;P '.formatNumber('currency',$works->workexp_salary).'</td>
           <td colspan="2" width="64" class="text">&nbsp;'.$works->workexp_salary_grade.'</td>
           <td colspan="2" width="64" class="text">&nbsp;'.$works->workexp_empstatus.'</td>
           <td colspan="2" width="32" class="text">&nbsp;'.$works->workexp_gov.'</td>
          </tr>';
  }
?>
<tr>
...
<?php
  foreach ($data['organization'] as $organizations) {
    # code...
    echo '<tr>
           <td colspan="8" width="288" class="text">'.$organizations->org_name.'<br>'.$organizations->org_add.'</td>
           <td colspan="2" width="32" class="text">&nbsp;'.$organizations->org_date_from.'</td>
           <td colspan="2" width="32" class="text">&nbsp;'.$organizations->org_date_to.'</td>
           <td colspan="2" width="32" class="text">&nbsp;'.$organizations->org_hours.'</td>
           <td colspan="7" width="288" class="text">&nbsp;'.$organizations->org_position.'</td>
          </tr>';
  }
?>
<tr>
...
<?php
  foreach ($data['training'] as $trainings) {
    ...
    echo '<tr>
           <td colspan="8" width="288" valign="top" class="text">&nbsp'.$trainings->training_title.'</td>
           <td colspan="2" width="32" valign="top" class="text">&nbsp'.$dur[0].'</td>
           <td colspan="2" width="32" valign="top" class="text">&nbsp'.$dur[--$ctr].'</td>
           <td colspan="2" width="32" valign="top" class="text" align="center">&nbsp'.$trainings->training_hours.'</td>
           <td colspan="2" width="32" valign="top" class="text" style="font-size:8px;text-align:center;">&nbsp'.$trainings->training_ld.'</td>
           <td colspan="5" width="256" valign="top" class="text">&nbsp'.$trainings->training_conducted_by.'</td>
          </tr>';
  }
?>
<tr>
...
<?php
  ...
  {
    echo '<tr>
            <td colspan="8" valign="top" class="text">';
    ...
    echo '</td>
            <td colspan="6" valign="top" class="text">';
    ...
    echo '</td>
            <td colspan="7" valign="top" class="text">';
...
<tr>
 ...
 <td colspan="8" width="256" class="noTopBot" valign="top">
  <table>
   <tr>
    <td class="text2">
 <input type="checkbox">&nbsp;YES&nbsp;&emsp;&nbsp;<input type="checkbox" checked>&nbsp;NO	</td>
   </tr>
   <tr>
