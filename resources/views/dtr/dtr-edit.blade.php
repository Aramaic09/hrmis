  ...
  <div class="modal-dialog modal-sm" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="POST" id="frm_dtr" enctype="multipart/form-data" role="form" action="{{ url('dtr/icos/update') }}">  
          {{ csrf_field() }}
...
<div class="modal fade" id="addWFH" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-sm" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="POST" id="frm_dtr" enctype="multipart/form-data" role="form" action="{{ url('dtr/icos/wfh') }}">  
          {{ csrf_field() }}
          <div class="form-group">
            <label for="formGroupExampleInput">TYPE</label>
            <br>
            <div class="form-check form-check-inline">
              <input class="form-check-input" type="radio" name="dtrStatus" id="inlineRadio1" value="WFH" checked>
          ...
          <input type="hidden" class="form-control" name="user_id_wfh" id="user_id_wfh" value="{{ $data['emp']['id'] }}">
