            ...
            <div class="card-body">
              <table id="tbl" class="table table-bordered table-striped">
                ...
                <tbody>
                    ...
                    @if(!checkIfProcess($lists->id,$data['mon'],$data['year']))
                    <tr>
                        <td><input type="checkbox" name="check_request[]" class="check" value="{{ $lists->id }}"></td>
                        ...
                        <td align="center">
                          <a href="#" onclick="submitFrm('edit',{{ $data['mon'] }},{{ $data['year'] }},{{ $lists->id }})"><i class="fas fa-edit text-primary" style="cursor: pointer"></i>&nbsp&nbsp</a>
                          <a href="#" onclick="submitFrm('pdf',{{ $data['mon'] }},{{ $data['year'] }},{{ $lists->id }})"><i class="fas fa-print text-success" style="cursor: pointer"></i>&nbsp&nbsp</a>
                          ...
                          <!-- <a href="#" onclick="submitFrm('monitor',{{ date('m',strtotime($lists->fldEmpDTRdate)) }},{{ date('Y',strtotime($lists->fldEmpDTRdate)) }},{{ $lists->user_id }})"><i class="fas fa-eye text-warning" style="cursor: pointer"></i>&nbsp&nbsp</a> -->
                           <a href="#" onclick="submitFrm('monitor',{{ $data['mon'] }},{{ $data['year'] }},{{ $lists->id }})"><i class="fas fa-eye text-warning" style="cursor: pointer"></i>&nbsp&nbsp</a>
                        </td>
                    </tr>
                    @endif
                    @endforeach
