...
<head>
  ...
  <link rel="stylesheet" href="{{ asset('AdminLTE-3.0.2/plugins/icheck-bootstrap/skins/all.css') }}">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      @if(Auth::user()->usertype == 'Administrator')
        @include('template.sidenav-admin')
      @elseif(Auth::user()->usertype == 'Director')
        @include('template.sidenav-director')
      @elseif(Auth::user()->usertype == 'Marshal')
        @include('template.sidenav-marshal')
      @elseif(Auth::user()->usertype == 'Staff')
        @include('template.sidenav-staff')
      @endif
...
<!-- iCheck for checkboxes and radio inputs -->
<script src="{{ asset('AdminLTE-3.0.2/plugins/icheck-bootstrap/icheck.js') }}"></script>
