                  ...
                  <div class="tab-pane fade show active" id="tabs-hiring" role="tabpanel" aria-labelledby="tabs-hiring-tab">
                    ...
                    <table id="tbl" class="table table-bordered table-striped">
                      ...
                      <tr>
                        ...
                        <th style="width: 15%" class="text-center">Vacancy Advise</th>
                      ...
                      <tbody>
                        @foreach($data['request_list'] AS $lists)
                            <tr>
                              ...
                              <td align="center">
                                @if($lists->request_status == 'Upload Vacancy Advise' || $lists->request_status == 'Re-upload Vacancy Advise for Reposting')
                                    -
                                @else
      ...
      <div class="modal fade" id="modal-request">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="div-content" id="div-content-vacancy" style="display: none">
                <div class="row">
                  <div class="col-md-12">
                    <strong>Vacancy Advise</strong>
                    <div class="form-group">
                    <div class="custom-file">
                            <input type="file" class="custom-file-input" name="request_vacancy" id="vacancyAdvise">
                            <label class="custom-file-label" for="vacancyAdvise">Choose file</label>
                    </div>
                  </div>
                </div>
              </div>
